...
const KIND2BAND = { "단원": "단원", "객원·대체": "객원·대체", "반주": "반주", "솔리스트": "솔리스트", "지휘": "지휘", "강사": "강사·레슨", "교수": "교수", "직원": "직원·스태프", "기타": "기타" };
...
const TIER_CLS = {
  ...
  "교육 — 취미·입문": "src-official", "미분류": "dd-always"
};
const BANDS = ["단원", "객원·대체", "반주", "솔리스트", "행사연주", "강사·레슨", "지휘", "교수", "직원·스태프", "기타"];
const INST_GROUPS = [
